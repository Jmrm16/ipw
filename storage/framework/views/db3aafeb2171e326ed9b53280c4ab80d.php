    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img class="img-fluid" src="<?php echo e(asset('img/carousel-1.jpg')); ?>" alt="Protección Total">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5 text-center" style="width: 100%; max-width: 900px;">
                        ...
                        <a href="<?php echo e(url('/services')); ?>" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Ver Servicios</a>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item">
                <img class="img-fluid" src="<?php echo e(asset('img/carousel-2.jpg')); ?>" alt="Asesoría Experta">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5 text-center" style="width: 100%; max-width: 900px;">
                        ...
                        <a href="<?php echo e(url('/contacto')); ?>" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Contáctanos</a>
                    </div>
                </div>
            </div>
            ...
            <!-- Slide 3 -->
            <div class="carousel-item">
                <img class="img-fluid" src="<?php echo e(asset('img/carousel-3.jpg')); ?>" alt="Clientes Felices">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5 text-center" style="width: 100%; max-width: 900px;">
                        ...
                        <a href="<?php echo e(url('/about')); ?>" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2">Conócenos</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="row align-items-center pb-1">
            <!-- Imagen -->
            <div class="col-lg-5">
                <img class="img-thumbnail p-3" src="<?php echo e(asset('img/about.jpg')); ?>" alt="Sobre Nosotros">
            </div>
            ...
            <div class="col-lg-7 mt-5 mt-lg-0">
                ...
                <a href="<?php echo e(url('/about')); ?>" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold">Leer Más</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-5">
                ...
                <a href="<?php echo e(url('/services')); ?>" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold">Descubre Más</a>
            </div>
                    ...
                    <div class="col-md-6 mb-5">
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a class="font-weight-semi-bold" href="<?php echo e(url('/services#vida')); ?>">Leer Más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-5">
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a href="<?php echo e(url('/seguros/medicos')); ?>" class="font-weight-semi-bold">Leer Más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-5">
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a class="font-weight-semi-bold" href="<?php echo e(url('/services#vehiculos')); ?>">Leer Más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-5">
                        <div class="d-flex">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <a class="font-weight-semi-bold" href="<?php echo e(url('/services#empresariales')); ?>">Leer Más <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto\aseguradora\resources\views/pages/home.blade.php ENDPATH**/ ?>