    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <a href="<?php echo e(url('/')); ?>" class="d-flex align-items-center mb-3 text-decoration-none">
                    <img src="<?php echo e(asset('img/logoB.png')); ?>" alt="Logo IPW" style="max-height: 60px;">
                </a>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="<?php echo e(url('/')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Inicio
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/about')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Quiénes Somos
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/services')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Servicios
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/requisitos')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Requisitos
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/contacto')); ?>" class="text-white text-decoration-none d-flex align-items-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2">
                        <a href="<?php echo e(url('/services#vida')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Seguros de Vida
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/services#medicos')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Seguros Médicos
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/services#vehiculos')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Seguros de Vehículos
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo e(url('/services#empresariales')); ?>" class="text-white text-decoration-none d-flex align-items-center">
                            <i class="bi bi-chevron-right me-2" style="color: #e74c3c;"></i>Seguros Empresariales
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('/services#sarlaft')); ?>" class="text-white text-decoration-none d-flex align-items-center">
