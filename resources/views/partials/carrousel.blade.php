    ...
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="{{ asset('img/carousel-1.jpg') }}" alt="Servicios Creativos">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('img/carousel-2.jpg') }}" alt="Equipo Profesional">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-md-3">Agencia Creativa</h5>
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="{{ asset('img/carousel-3.jpg') }}" alt="Clientes Satisfechos">
                <div class="carousel-caption d-flex align-items-center justify-content-center">
                    <div class="p-5" style="width: 100%; max-width: 900px;">
                        <h5 class="text-white text-uppercase mb-md-3">Agencia Creativa</h5>
