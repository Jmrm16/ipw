            ...
            <div class="bg-white p-3 rounded-lg shadow border-l-2 border-blue-500">
                <div class="flex items-center gap-2">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">{{ $formularios->count() }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-3 rounded-lg shadow border-l-2 border-yellow-500">
                <div class="flex items-center gap-2">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">{{ $formularios->where('estado', 'pendiente')->count() }}</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-3 rounded-lg shadow border-l-2 border-green-500">
                <div class="flex items-center gap-2">
                    ...
                    <div class="overflow-hidden">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">{{ $formularios->where('estado', 'finalizado')->count() }}</h3>
                    </div>
                </div>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($formularios as $formulario)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    @endphp
                                    <span class="px-2 py-0.5 md:px-3 md:py-1 rounded-full text-xs font-semibold {{ $color }}">
                                        {{ $etiqueta }}
                                    </span>
                                   </td>
                                    ...
                                    <td class="px-4 py-3 md:px-6 md:py-4 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <span class="px-2 py-0.5 md:px-3 md:py-1 rounded-full text-xs font-semibold {{ $estadoColor }} inline-flex items-center">
                                                        ...
                                                        <div @click.away="showPagoModal = false"
                                                            ...
                                                            <div class="bg-blue-600 text-white px-4 py-3 sm:px-6 sm:py-4 rounded-t-xl flex justify-between items-center">
                                                                <h2 class="text-base sm:text-lg font-semibold flex items-center gap-2">
                                                                    ...
                                                                    <span class="truncate">Pago - Formulario #{{ $formulario->id }}</span>
                                                                </h2>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <form action="{{ route('formulario.subir-constancia', $formulario->id) }}" 
                                                                                ...
                                                                                <div class="flex items-center justify-center w-full">
                                                                                    <label for="dropzone-file-{{ $formulario->id }}" class="flex flex-col items-center justify-center w-full h-28 sm:h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                                                                                        ...
                                                                                        <input id="dropzone-file-{{ $formulario->id }}" 
                                                                                            type="file" 
                                                                                            name="documento" 
...
<div class="fixed bottom-4 right-4 z-40 lg:hidden">
    ...
    <div id="mobileActionsMenu" class="hidden absolute bottom-16 right-0 w-48 bg-white rounded-lg shadow-xl border border-gray-200 p-2 space-y-2">
        ...
        <a href="{{ route('documentos.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
            <i class="ri-folder-upload-line mr-2 text-blue-500"></i> Subir Documentos
        </a>
        <a href="{{ route('perfil.show') }}" class="flex items-center px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
